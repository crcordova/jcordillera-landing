...
const WA_MESSAGE = process.env.NEXT_PUBLIC_WHATSAPP_MESSAGE || 'Hola%2C%20quiero%20saber%20m%C3%A1s%20sobre%20Jard%C3%ADn%20Cordillera';
    ...
    <section id="hero" className={styles.hero}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.stats}>
          ...
          <div className={styles.statDivider} aria-hidden="true" />
          <div className={styles.stat}>
            <span className={styles.statNum}>3 Gen</span>
            <span className={styles.statLabel}>Familia</span>
          </div>
        </div>
